---
title: "flat_livelihood_analysis.Rmd for working package"
...
datafile <- system.file("nyc_squirrels_sample.csv", package = "RuralObsAnalyseR")
...
fusen::inflate(flat_file = "dev/flat_livelihood_analysis.Rmd", vignette_name = "Get started")
```
